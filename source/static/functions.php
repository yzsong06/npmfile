...
?>
    ...
    $JLive2D = new Typecho_Widget_Helper_Form_Element_Select(
        ...
        array(
            'off' => '关闭（默认）',
            'https://npm.elemecdn.com/live2d-widget-model-shizuku@1.0.5/assets/shizuku.model.json' => 'shizuku',
            'https://npm.elemecdn.com/live2d-widget-model-izumi@1.0.5/assets/izumi.model.json' => 'izumi',
            'https://npm.elemecdn.com/live2d-widget-model-haru@1.0.5/01/assets/haru01.model.json' => 'haru01',
            'https://npm.elemecdn.com/live2d-widget-model-haru@1.0.5/02/assets/haru02.model.json' => 'haru02',
            'https://npm.elemecdn.com/live2d-widget-model-wanko@1.0.5/assets/wanko.model.json' => 'wanko',
            'https://npm.elemecdn.com/live2d-widget-model-hijiki@1.0.5/assets/hijiki.model.json' => 'hijiki',
            'https://npm.elemecdn.com/live2d-widget-model-koharu@1.0.5/assets/koharu.model.json' => 'koharu',
            'https://npm.elemecdn.com/live2d-widget-model-z16@1.0.5/assets/z16.model.json' => 'z16',
            'https://npm.elemecdn.com/live2d-widget-model-haruto@1.0.5/assets/haruto.model.json' => 'haruto',
            'https://npm.elemecdn.com/live2d-widget-model-tororo@1.0.5/assets/tororo.model.json' => 'tororo',
            'https://npm.elemecdn.com/live2d-widget-model-chitose@1.0.5/assets/chitose.model.json' => 'chitose',
            'https://npm.elemecdn.com/live2d-widget-model-miku@1.0.5/assets/miku.model.json' => 'miku',
            'https://npm.elemecdn.com/live2d-widget-model-epsilon2_1@1.0.5/assets/Epsilon2.1.model.json' => 'Epsilon2.1',
            'https://npm.elemecdn.com/live2d-widget-model-unitychan@1.0.5/assets/unitychan.model.json' => 'unitychan',
            'https://npm.elemecdn.com/live2d-widget-model-nico@1.0.5/assets/nico.model.json' => 'nico',
            'https://npm.elemecdn.com/live2d-widget-model-rem@1.0.1/assets/rem.model.json' => 'rem',
            'https://npm.elemecdn.com/live2d-widget-model-nito@1.0.5/assets/nito.model.json' => 'nito',
            'https://npm.elemecdn.com/live2d-widget-model-nipsilon@1.0.5/assets/nipsilon.model.json' => 'nipsilon',
            'https://npm.elemecdn.com/live2d-widget-model-ni-j@1.0.5/assets/ni-j.model.json' => 'ni-j',
            'https://npm.elemecdn.com/live2d-widget-model-nietzsche@1.0.5/assets/nietzche.model.json' => 'nietzche',
            'https://npm.elemecdn.com/live2d-widget-model-platelet@1.1.0/assets/platelet.model.json' => 'platelet',
            'https://npm.elemecdn.com/live2d-widget-model-isuzu@1.0.4/assets/model.json' => 'isuzu',
            'https://npm.elemecdn.com/live2d-widget-model-jth@1.0.0/assets/model/katou_01/katou_01.model.json' => 'katou_01',
            'https://npm.elemecdn.com/live2d-widget-model-mikoto@1.0.0/assets/mikoto.model.json' => 'mikoto',
            'https://npm.elemecdn.com/live2d-widget-model-mashiro-seifuku@1.0.1/assets/seifuku.model.json' => 'seifuku',
            'https://npm.elemecdn.com/live2d-widget-model-ichigo@1.0.1/assets/ichigo.model.json' => 'ichigo',
            'https://npm.elemecdn.com/live2d-widget-model-hk_fos@1.0.0/assets/hk416.model.json' => 'hk416'
  ...
  'JactiveUsers',
    ...
    $JRanking = new Typecho_Widget_Helper_Form_Element_Select(
        ...
        array(
            ...
            '搜狐新闻榜$sohu_news' => '搜狐新闻榜',
            '腾讯新闻榜$tencent_news' => '腾讯新闻榜',
            '360实时热点$so_hot' => '360实时热点',
            '百度实时热点$baidu_ssrd' => '百度实时热点',
            '网易实时热点$en_today' => '网易实时热点',
            '参考消息热点$cankaoxiaoxi' => '参考消息热点',
            'ReadHub热点$readhub' => 'ReadHub热点',
            '极客公园热点$geekpark' => '极客公园热点',
            '一财网热点$yicai_hot' => '一财网热点',
            '历史今天$lssdjt' => '历史今天',
            ...
            '新京报今日热门榜$bjnews' => '新京报今日热门榜',
            '人民日报实时热点$people' => '人民日报实时热点',
            '雪球话题榜$xueqiu' => '雪球话题榜',
            '格隆汇热点$gelonghui' => '格隆汇热点',
    ...
    $JFriends = new Typecho_Widget_Helper_Form_Element_Textarea(
        ...
        '介绍：用于填写友情链接 <br />
         ...
         格式：博客名称 || 博客地址 || 博客头像 || 博客简介 || 图片背景 <br />
